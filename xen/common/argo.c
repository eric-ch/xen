               ...
               XEN_GUEST_HANDLE(xen_argo_ring_data_ent_t) data_ent_hnd)
{
    ...
    if ( ring_info )
    {
        ...
        else
        {
            ...
            {
                /*
                 * Too many other domains are already awaiting notification about
                 * available space on this ring. Indicate this state via flag.
                 * No need to return an error to the caller; allow the
